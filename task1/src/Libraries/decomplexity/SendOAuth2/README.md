...
```
{
 ...
 "scripts": {
        "pre-autoload-dump": "Libraries\\League\\OAuth2\\Google\\Task\\Composer::cleanup"
        },
        "extra": {
...
use Libraries\decomplexity\SendOAuth2\SendOauth2D;require 'vendor/autoload.php';
...
```php
namespace decomplexity\SendOauth2;
use Libraries\decomplexity\SendOAuth2\SendOauth2A;session_start();
require 'vendor/autoload.php';
