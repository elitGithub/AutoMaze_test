...
namespace Libraries\League\OAuth2\Client\Provider;

use Firebase\JWT\JWK;
use Firebase\JWT\JWT;
use Firebase\JWT\Key;
use Libraries\League\OAuth2\Client\Grant\JwtBearer;
use Libraries\League\OAuth2\Client\Token\AccessToken;
use Libraries\League\OAuth2\Grant\AbstractGrant;
use Libraries\League\OAuth2\Provider\Exception\IdentityProviderException;
use Libraries\League\OAuth2\Provider\ResourceOwnerInterface;
use Libraries\League\OAuth2\Token\AccessTokenInterface;
use Libraries\League\OAuth2\Tool\BearerAuthorizationTrait;
use Psr\Http\Message\RequestInterface;
use Psr\Http\Message\ResponseInterface;

class Azure extends \Libraries\League\OAuth2\Provider\AbstractProvider
{
     ...
     * @inheritdoc
     */
    public function getResourceOwner(\Libraries\League\OAuth2\Token\AccessToken $token): ResourceOwnerInterface
    {
     ...
     * @inheritdoc
     */
    public function getResourceOwnerDetailsUrl(\Libraries\League\OAuth2\Token\AccessToken $token): string
    {
        $openIdConfiguration = $this->getOpenIdConfiguration($this->tenant, $this->defaultEndPointVersion);
    ...
    /**
     * @param $accessToken \Libraries\League\OAuth2\Client\Token\AccessToken|null
     *
     * @return string
     */
     ...
     * @inheritdoc
     */
    protected function createResourceOwner(array $response, \Libraries\League\OAuth2\Token\AccessToken $token): AzureResourceOwner
    {
