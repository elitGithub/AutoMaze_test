...
namespace Libraries\League\OAuth2\Client\Token;

use Firebase\JWT\JWT;
use RuntimeException;
use TheNetworg\OAuth2\Client\Token\JWT_Exception;

class AccessToken extends \Libraries\League\OAuth2\Token\AccessToken
{
    protected $idToken;
    ...
    /**
     * @param \Libraries\League\OAuth2\Client\Provider\Azure  $provider
     */
