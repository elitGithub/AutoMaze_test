...
{
    /**
     * If you need to specify a NULL JSON value, use Libraries\League\OAuth2\Google\Model::NULL_VALUE
     ...
     *
     * @throws \Libraries\League\OAuth2\Google\Exception Thrown if $obj isn't an array.
     *
