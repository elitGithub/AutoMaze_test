...
namespace Libraries\League\OAuth2\Google\Service;

use Google\Service\RequestInterface;
use Google\Service\ResponseInterface;
use GuzzleHttp\Psr7\Request;
use Libraries\League\OAuth2\Google\Exception as GoogleException;
use Libraries\League\OAuth2\Google\Http\MediaFileUpload;
use Libraries\League\OAuth2\Google\Model;
use Libraries\League\OAuth2\Google\Utils\UriTemplate;
...
class Resource
{
    ...
    /** @var \Libraries\League\OAuth2\Google\Client $client */
    private $client;
