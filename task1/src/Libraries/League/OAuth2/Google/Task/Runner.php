...
namespace Libraries\League\OAuth2\Google\Task;

use Libraries\League\OAuth2\Google\Service\Exception as GoogleServiceException;
use Libraries\League\OAuth2\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     *
     * @throws \Libraries\League\OAuth2\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \Libraries\League\OAuth2\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
