...
use Libraries\League\OAuth2\Google\Client;
 ...
 *
 * Note that calls to `Libraries\League\OAuth2\Google\Http\Batch::execute()` do not clear the queued
        ...
        if (!empty($body)) {
            ...
            foreach ($parts as $i => $part) {
                ...
                if (!empty($part)) {
                    ...
                    [$partHeaders, $partBody] = $this->parseHttpResponse($part, 0);
