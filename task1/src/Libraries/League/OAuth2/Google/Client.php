...
use Libraries\League\OAuth2\Google\AccessToken\Revoke;
use Libraries\League\OAuth2\Google\AccessToken\Verify;
use Libraries\League\OAuth2\Google\AuthHandler\AuthHandlerFactory;
use Libraries\League\OAuth2\Google\Http\REST;
use LogicException;
use Libraries\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Libraries\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
     ...
     *           {@see \Libraries\League\OAuth2\Google\Task\Runner}
    ...
    public function fetchAccessTokenWithAssertion(ClientInterface $authHttp = null)
    {
        if (!$this->isUsingApplicationDefaultCredentials()) {
            throw new DomainException(
                ...
                . ' Libraries\League\OAuth2\Google\Client::setAuthConfig or set the path to your JSON file'
                . ' with the "GOOGLE_APPLICATION_CREDENTIALS" environment variable'
                . ' and call Libraries\League\OAuth2\Google\Client::useApplicationDefaultCredentials to'
     ...
     *@throws \Libraries\League\OAuth2\Google\Exception
     */
