 ...
 *
 *      $logger = new \Libraries\Monolog\Logger('all', array(new \Libraries\Monolog\Handler\PHPConsoleHandler()));
 *      \Libraries\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    /**
     * @param  array<string, mixed> $options   See \Libraries\Monolog\Handler\PHPConsoleHandler::$options for more details
