...
namespace Libraries\Monolog\Handler\Slack;

use Libraries\Monolog\Logger;
use Libraries\Monolog\Utils;
use Libraries\Monolog\Formatter\NormalizerFormatter;
 ...
 *
 * @phpstan-import-type FormattedRecord from \Libraries\Monolog\Handler\AbstractProcessingHandler
...
class SlackRecord
{
    ...
    /**
     * @var \Libraries\Monolog\Formatter\NormalizerFormatter
     */
