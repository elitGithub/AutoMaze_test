...
/**
 * HttpResponseCodes provides named constants for
...
class HttpResponseCodes
{
    ...
    public const HTTP_ENTITY_UNPROCESSABLE = 422;
    public const HTTP_TOO_EARLY = 425;
    public const HTTP_UPGRADE_REQUIRED = 426;
    public const HTTP_PRECONDITION_REQUIRED = 428;
    public const HTTP_TOO_MANY_REQUESTS = 426;
    public const HTTP_REQUEST_HEADER_TOO_LARGE = 431;
    public const HTTP_LEGALLY_UNAVAILABLE = 451;
    ...
    private static array $messages = [
        ...
        422 => '422 Entity not processable',
        425 => '425 Too Early',
